...
--
-- Host: 127.0.0.1:3307
-- Tempo de geração: 27/05/2026 às 01:02
...
('root', '[{\"db\":\"Schumacher_1445BN\",\"table\":\"usuarios\"}]');
...
('root', '2026-05-26 23:02:07', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"pt_BR\",\"Export\\/file_template_server\":\"atendelab\"}');
...
ALTER TABLE `pma__savedsearches`
  MODIFY `id` int(5) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- Banco de dados: `schumacher_1445bn`
--
...
(1, 'Administrador', 'admin@atendelab.com', '$2y$10$J9P2kU2BAMZ3TZcuxTsW4e1D/lka8EocYHzvyoOZmCNcWDQz3RuVC', 'admin', 'ativo', '2026-05-26 22:58:29');
